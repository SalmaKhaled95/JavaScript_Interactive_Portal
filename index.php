 <?php
			  ...
			  if (isset($_REQUEST['username']) && isset($_REQUEST['password'])) {
				  ...
				  if ($conn)
				  {
					  ...
					  $SQL = "SELECT * FROM `posts` ORDER BY `publish_date` Desc  LIMIT 4;";
			 ...
			 $_REQUEST['username']= "Admin";
			  ...
			  if (isset($_REQUEST['username']) && isset($_REQUEST['password'])) {
				  ...
				  if ($conn)
				  {
					  ...
					  //if ($conn->connect_error) {echo "error";}
					  //else {echo "ok";}
					  //id, title, content, publish_date, created_at, updated_at, category_id, user_id, image
			 while ($row = mysqli_fetch_assoc($query) ){
				
				// echo print_r($row);       // Print the entire row data
				 $TheID = $row['category_id'];
				 $userID = $row['user_id'];
					//  echo "\n";
					  
					  $categoriesSQL = "SELECT * FROM `categories` WHERE `id` = " .$TheID .";";
					  $categoriesQuery = mysqli_query( $conn , $categoriesSQL );
					  $categoriesRow = mysqli_fetch_assoc($categoriesQuery);
					  
					  $UserSQL = "SELECT * FROM `users` WHERE `id` = " .$userID .";";
					  $UserQuery = mysqli_query( $conn , $UserSQL );
					  $UserRow = mysqli_fetch_assoc($UserQuery);
					  
					  $CommentSQL = "SELECT IFNULL((SELECT COUNT(*) as CountColumn FROM `comments` WHERE `post_id` = " .$row['id'] ."),0) As countcl";  
					  $CommentQuery = mysqli_query( $conn , $CommentSQL );
					  $CommentRow = mysqli_fetch_assoc($CommentQuery);
					  
					  
					  $TagsSQL = "SELECT `tag_id` FROM `post_tags` WHERE `post_id` = " .$row['id'] .";";  
					  $TagsQuery = mysqli_query( $conn , $TagsSQL );
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <span><?php echo $categoriesRow['name'] ?></span>
                      <a href="post-details.html"><h4><?php echo  $row['title']   ?> </h4></a>
                      <ul class="post-info">
                        <li><a href="#"><?php echo  $UserRow['name']   ?> </a></li>
                        <li><a href="#"><?php echo  $row['publish_date']   ?></a></li>
                        <li><a href="#"><?php echo  $CommentRow['countcl']   ?> Comments</a></li>
                      </ul>
                          ...
                          <div class="col-6">
                            <ul class="post-tags">
							  ...
							  while( $TagsRow = mysqli_fetch_assoc($TagsQuery)){
								  foreach ($TagsRow as $OneTagID){
								  $TagNameSQL = "SELECT `name` FROM `tags` WHERE `id` = " .$OneTagID  .";"; 
//echo		$TagNameSQL;		  
					  $TagNameQuery = mysqli_query( $conn , $TagNameSQL );
					 $TagNameRow = mysqli_fetch_assoc($TagNameQuery);
					 // echo  $TagNameRow;
								  
								  //
								  
					    ?>
                              <li><a href="#"> <?php  echo  $TagNameRow['name']  ?></a>,</li>
                              <?php
							  }}
							    ?>
                            </ul>
