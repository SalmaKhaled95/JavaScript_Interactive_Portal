...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="http://localhost:8012/myposts/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">


    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="http://localhost:8012/myposts/assets/css/fontawesome.css">
    <link rel="stylesheet" href="http://localhost:8012/myposts//assets/css/templatemo-stand-blog.css">
    <link rel="stylesheet" href="http://localhost:8012/myposts//assets/css/owl.css">
    <!--
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item <?= ($current_page == 'home' ? "active" : "") ?>">
                            <a class="nav-link" href="http://localhost:8012/myposts/">Home
                                <?= ($current_page == 'home' ? "<span class='sr-only'>(current)</span>" : "") ?>
                            </a>
                        </li>
                        <li class="nav-item <?= ($current_page == 'posts' ? "active" : "") ?>">
                            <a class="nav-link" href="http://localhost:8012/myposts/">Posts</a>
